...
<div class="content__container">
    <div class="row">
        <div class="section__container-wform col-md-8">
            <h4 class="content__title">Selamat Datang di ERepair</h4>
            <p class="content__subtitle">Buat akun baru</p>
            <form action="#" method="post" id="sign_up__form" class="mt-3">
                ...
                <div class="button__container">
                    <button type="submit" class="section__button--white mt-3">Daftar</button>
                </div>
            </form>
        </div>
        <div class="section__container-wbutton section__container-wbutton-right col-md-4">
            ...
            <a href="./login.php">
                <button type="button" class="section__button--blue">Masuk</button>
            </a>
        </div>
    </div>
</div>
